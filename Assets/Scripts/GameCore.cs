...
public class GameCore : MonoBehaviour {
    ...
    public bool HasNextLevel() { return levels.Length > 0 && SceneManager.GetActiveScene().buildIndex - ignoredScenes < levels.Length; } // add ignored scenes to make sure there are actually more levels to load
